module ApplicationHelper
  ...
  def flash_classes(flash_type)
    flash_base =
      'px-2 py-4 mx-auto font-sans font-medium text-center text-white'
    {
  ...
  def style_button(variant, theme)
    base =
      'rounded text-center font-sans font-normal outline-none leading-normal cursor-pointer transition ease-in-out duration-200 font-medium'
